         ...
         <div className="h-auto w-auto flex">
            <div className="h-auto w-[300px] flex">
               <div className="-z-1 absolute">
                  ...
                  >
                     <path
                        d="M0 0H322V142V213L372 248.5L322 284H0V0Z"
                        fill="url(#paint0_linear_314_880)"
                     />
                     <path
                        d="M0 0H322V142V213L372 248.5L322 284H0V0Z"
                        fill="url(#paint1_radial_314_880)"
                        fill-opacity="0.2"
                     />
                     <defs>
                        <linearGradient
                           id="paint0_linear_314_880"
                           x1="161"
                           y1="6.229e-05"
                           x2="-6.24504"
                           y2="271.44"
                        ...
                        <radialGradient
                           id="paint1_radial_314_880"
                           cx="0"
                           cy="0"
                           r="1"
                           gradientUnits="userSpaceOnUse"
                           gradientTransform="translate(238.369 104.004) rotate(111.743) scale(208.855 256.681)"
                        >
