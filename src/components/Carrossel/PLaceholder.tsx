   ...
   return (
      <main className="w-full">
         <div className="flex">
            ...
            <div
               id="slidercontainer"
               className="w-full h-auto md:h-[340px] bg-transparent flex items-center scroll-smooth snap-x overflow-x-scroll cursor-grabbing"
            >
               {/* <div className="absolute right-0 w-1/2 h-[340px] bg-gradient-to-l from-offblack to-transparent select-none"></div> */}
               <div
                  id="slider"
                  className=" h-auto md:h-[300px] flex w-full grow-1"
               >
                  <MovieCard />
                  <MovieCard />
                  <MovieCard />
